...
- ✅ `robots.txt`: Sitemap actualizado a `https://ciñera.es/sitemap-index.xml`
- ✅ `faedo-de-cinera.md`: GPX URL actualizada a `https://ciñera.es/gpx/faedo.gpx`
  ...
  "itemListElement": [
    {
      ...
      "position": 1,
      "name": "Inicio",
      "item": "https://ciñera.es/"
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "La Ruta",
      "item": "https://ciñera.es/ruta/faedo-de-cinera"
    }
  ]
}
```
